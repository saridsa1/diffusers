...
You can now convert to ckpt format using this script to use in UIs like AUTOMATIC1111. https://github.com/saridsa1/diffusers/raw/main/scripts/convert_diffusers_to_original_stable_diffusion.py Check colab notebook for example usage.

[![DreamBooth Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/saridsa1/diffusers/blob/main/examples/dreambooth/DreamBooth_Stable_Diffusion.ipynb)
...
```bash
pip install git+https://github.com/saridsa1/diffusers.git
